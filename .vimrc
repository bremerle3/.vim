...
let g:syntastic_java_javac_config_file_enabled = 1 " Classpath for java
let g:syntastic_c_include_dirs = [ '../include', 'include'] " Include dirs for C
let g:syntastc_cpp_check_header = 1 "Check C header files
" YCM Settings """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" Shut the stupid autocompleter up
